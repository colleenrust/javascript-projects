...
const testString = 'Hip Hip Hooray!';
const testNumbs= 12345;
console.log(reverseCharacters(testString));
console.log(reverseCharacters(testNumbs));
...
let side = 7;
console.log(`The area is ${calculateArea(side)} cm^2.`)